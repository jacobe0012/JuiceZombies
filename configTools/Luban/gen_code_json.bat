...
%GEN_CLIENT% -j cfg --^
 ...
 --output_code_dir %PARENT_WORKSPACE%\trunk\Dev\Assets\JuiceZombies\ConfigGenScripts\GenScripts ^
 --output_data_dir %PARENT_WORKSPACE%\trunk\Dev\Assets\JuiceZombies\ConfigJsonData ^
