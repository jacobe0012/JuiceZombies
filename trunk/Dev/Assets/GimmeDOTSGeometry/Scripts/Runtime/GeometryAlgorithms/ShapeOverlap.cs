...
namespace GimmeDOTSGeometry
{
    public static class ShapeOverlap
    {
        ...
        public static bool LineSegmentSphereOverlap(LineSegment3D line, float3 center, float radiusSq)
        {
            ...
            {
                bool closestPointIsOnSegment =
                    math.dot(dir, closestPoint - a) >= 0.0f && math.dot(-dir, closestPoint - b) >= 0.0f;
                return closestPointIsOnSegment;
            }
        }
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool CircleContainsCircle(float2 circleCenter0, float radiusSq0, float2 circleCenter1,
            float radiusSq1)
        {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool SphereContainsSphere(float3 sphereCenter0, float radiusSq0, float3 sphereCenter1,
            float radiusSq1)
        {
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool CircleCircleOverlap(float2 circleCenter0, float radiusSq0, float2 circleCenter1,
            float radiusSq1)
        {
            float dirLength = math.lengthsq(circleCenter1 - circleCenter0);
        ...
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool SphereSphereOverlap(float3 sphereCenter0, float radiusSq0, float3 sphereCenter1,
            float radiusSq1)
        {
            float dirLength = math.lengthsq(sphereCenter1 - sphereCenter0);
            return radiusSq0 + radiusSq1 + 2.0f * math.sqrt(radiusSq0 * radiusSq1) > dirLength;
