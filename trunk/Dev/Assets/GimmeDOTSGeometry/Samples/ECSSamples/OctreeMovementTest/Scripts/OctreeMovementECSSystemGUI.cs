...
{
    public class OctreeMovementECSSystemGUI : SystemGUI
    {
        public OctreeMovementECSSystem system;
        ...
        protected override void OnGUI()
        {
            ...
            GUILayout.Box("ECS Octree Movement GUI");
            GUILayout.Label($"Current points: {this.system.GetNrOfPoints()}", this.textStyle);

            GUILayout.Label($"Octree Depth {this.system.CurrentSearchDepth}");

            int depth = (int)GUILayout.HorizontalSlider(this.system.CurrentSearchDepth, 1, 7);
            ...
            if(this.system.IsUsingSparseOctree())
            {
                if(this.GUIButton("Use Dense Octree"))
                {
                    this.system.ExchangeOctreeModel();
                }
            } else
            {
