...
namespace Rewired.UI.ControlMapper
{
    ...
    public partial class ControlMapper
    {
        ...
        private class GUIButton : GUIElement
        {
            ...
            {
                get { return selectable as Button; }
            }

            public ButtonInfo buttonInfo
            {
                get { return uiElementInfo as ButtonInfo; }
            }
        ...
        private class GUIInputField : GUIElement
        {
            ...
            {
                get { return uiElementInfo as InputFieldInfo; }
            }

            public bool hasToggle
            {
                get { return toggle != null; }
            }
            ...
            public virtual void SetInteractable(bool state, bool playTransition, bool permanent)
            {
                if (permanentStateSet) return;
                if (hasToggle && !state)
                    toggle.SetInteractible(state, playTransition, permanent); // disable toggle if main element disabled
        ...
        private class GUIToggle : GUIElement
        {
            ...
            {
                get { return selectable as Toggle; }
            }

            public ToggleInfo toggleInfo
            {
                get { return uiElementInfo as ToggleInfo; }
            }
        ...
        public class MappingSet
        {
            ...
            [SerializeField]
            [Tooltip(
                "Choose whether you want to list Actions to display for this Map Category by individual Action or by all the Actions in an Action Category.")]
            private ActionListMode _actionListMode;

            [SerializeField] private int[] _actionCategoryIds;
            [SerializeField] private int[] _actionIds;
            ...
            {
                get { return _mapCategoryId; }
            }

            public ActionListMode actionListMode
            {
                get { return _actionListMode; }
            }
                ...
                get
                {
                    ...
                    if (_actionCategoryIdsReadOnly == null)
                        _actionCategoryIdsReadOnly =
                            new System.Collections.ObjectModel.ReadOnlyCollection<int>(_actionCategoryIds);
            ...
            public IList<int> actionIds
            {
                get
                {
                    ...
                    if (_actionIdsReadOnly == null)
                        _actionIdsReadOnly = new System.Collections.ObjectModel.ReadOnlyCollection<int>(_actionIds);
                    return _actionIds;
                }
            }
            ...
            private MappingSet(int mapCategoryId, ActionListMode actionListMode, int[] actionCategoryIds,
                int[] actionIds)
            {
        ...
        public class InputBehaviorSettings
        {
            ...
            [SerializeField]
            [Tooltip(
                "If set to a non-blank value, this key will be used to look up the name in Language to be displayed as the title for the Input Behavior control set. Otherwise, the name field of the InputBehavior will be used.")]
            private string _labelLanguageKey = string.Empty;

            [SerializeField]
            [Tooltip(
                "If set to a non-blank value, this name will be displayed above the individual slider control. Otherwise, no name will be displayed.")]
            private string _joystickAxisSensitivityLabelLanguageKey = string.Empty;

            [SerializeField]
            [Tooltip(
                "If set to a non-blank value, this key will be used to look up the name in Language to be displayed above the individual slider control. Otherwise, no name will be displayed.")]
            ...
            {
                get { return _inputBehaviorId; }
            }

            public bool showJoystickAxisSensitivity
            {
                get { return _showJoystickAxisSensitivity; }
            }

            public bool showMouseXYAxisSensitivity
            {
                get { return _showMouseXYAxisSensitivity; }
            }

            public string labelLanguageKey
            {
                get { return _labelLanguageKey; }
            }

            public string joystickAxisSensitivityLabelLanguageKey
            {
                get { return _joystickAxisSensitivityLabelLanguageKey; }
            }

            public string mouseXYAxisSensitivityLabelLanguageKey
            {
                get { return _mouseXYAxisSensitivityLabelLanguageKey; }
            }

            public Sprite joystickAxisSensitivityIcon
            {
                get { return _joystickAxisSensitivityIcon; }
            }

            public Sprite mouseXYAxisSensitivityIcon
            {
                get { return _mouseXYAxisSensitivityIcon; }
            }

            public float joystickAxisSensitivityMin
            {
                get { return _joystickAxisSensitivityMin; }
            }

            public float joystickAxisSensitivityMax
            {
                get { return _joystickAxisSensitivityMax; }
            }

            public float mouseXYAxisSensitivityMin
            {
                get { return _mouseXYAxisSensitivityMin; }
            }

            public float mouseXYAxisSensitivityMax
            {
                get { return _mouseXYAxisSensitivityMax; }
            }

            public bool isValid
            {
                get { return _inputBehaviorId >= 0 && (_showJoystickAxisSensitivity || _showMouseXYAxisSensitivity); }
            } // || _showMouseOtherAxisSensitivity); } }
        ...
        private class Prefabs
        {
            ...
            [SerializeField] private GameObject _fitButton;
            [SerializeField] private GameObject _inputGridLabel;
            [SerializeField] private GameObject _inputGridHeaderLabel;
            [SerializeField] private GameObject _inputGridFieldButton;
            [SerializeField] private GameObject _inputGridFieldInvertToggle;
            [SerializeField] private GameObject _window;
            [SerializeField] private GameObject _windowTitleText;
            [SerializeField] private GameObject _windowContentText;
            [SerializeField] private GameObject _fader;
            [SerializeField] private GameObject _calibrationWindow;
            [SerializeField] private GameObject _inputBehaviorsWindow;

            // Optional
            [SerializeField] private GameObject _centerStickGraphic;
            [SerializeField] private GameObject _moveStickGraphic;
            ...
            {
                get { return _inputGridLabel; }
            }

            public GameObject inputGridHeaderLabel
            {
                get { return _inputGridHeaderLabel; }
            }

            public GameObject inputGridFieldButton
            {
                get { return _inputGridFieldButton; }
            }

            public GameObject inputGridFieldInvertToggle
            {
                get { return _inputGridFieldInvertToggle; }
            }
            ...
            {
                get { return _calibrationWindow; }
            }

            public GameObject inputBehaviorsWindow
            {
                get { return _inputBehaviorsWindow; }
            }

            public GameObject centerStickGraphic
            {
                get { return _centerStickGraphic; }
            }

            public GameObject moveStickGraphic
            {
                get { return _moveStickGraphic; }
            }
        ...
        private class References
        {
            ...
            [SerializeField] private Transform _mainContentInner;
            [SerializeField] private UIGroup _playersGroup;
            [SerializeField] private Transform _controllerGroup;
            [SerializeField] private Transform _controllerGroupLabelGroup;
            [SerializeField] private UIGroup _controllerSettingsGroup;
            [SerializeField] private UIGroup _assignedControllersGroup;
            [SerializeField] private Transform _settingsAndMapCategoriesGroup;
            [SerializeField] private UIGroup _settingsGroup;
            [SerializeField] private UIGroup _mapCategoriesGroup;
            [SerializeField] private Transform _inputGridGroup;
            [SerializeField] private Transform _inputGridContainer;
            [SerializeField] private Transform _inputGridHeadersGroup;
            [SerializeField] private Scrollbar _inputGridVScrollbar;
            [SerializeField] private ScrollRect _inputGridScrollRect;
            [SerializeField] private Transform _inputGridInnerGroup;
            [SerializeField] private Text _controllerNameLabel;
            [SerializeField] private Button _removeControllerButton;
            [SerializeField] private Button _assignControllerButton;
            [SerializeField] private Button _calibrateControllerButton;
            [SerializeField] private Button _doneButton;
            [SerializeField] private Button _restoreDefaultsButton;
            [SerializeField] private Selectable _defaultSelection;
            [SerializeField] private GameObject[] _fixedSelectableUIElements;
            ...
            {
                get { return _controllerGroup; }
            }

            public Transform controllerGroupLabelGroup
            {
                get { return _controllerGroupLabelGroup; }
            }

            public UIGroup controllerSettingsGroup
            {
                get { return _controllerSettingsGroup; }
            }

            public UIGroup assignedControllersGroup
            {
                get { return _assignedControllersGroup; }
            }

            public Transform settingsAndMapCategoriesGroup
            {
                get { return _settingsAndMapCategoriesGroup; }
            }
            ...
            {
                get { return _restoreDefaultsButton; }
            }
            ...
            {
                get { return _fixedSelectableUIElements; }
            }
        ...
        private class InputMapping
        {
                ...
                get
                {
                    ...
                    if (pollingInfo.elementType == ControllerElementType.Axis)
                    {
                        if (fieldInfo.axisRange == AxisRange.Full) axisRange = AxisRange.Full;
                            ...
                            axisRange = pollingInfo.axisPole == Pole.Positive ? AxisRange.Positive : AxisRange.Negative;
                    }
            ...
            public string elementName
            {
                get
                {
                    ...
                    {
                        return ControlMapper.GetLanguage()
                            .GetElementIdentifierName(pollingInfo.keyboardKey, modifierKeyFlags);
                    }
                    else
                    {
                        return ControlMapper.GetLanguage().GetElementIdentifierName(pollingInfo.controller,
                            pollingInfo.elementIdentifierId,
                            pollingInfo.axisPole == Pole.Positive ? AxisRange.Positive : AxisRange.Negative);
                    }
                }
            }

            public InputMapping(string actionName, InputFieldInfo fieldInfo, ControllerMap map, ActionElementMap aem,
                ControllerType controllerType, int controllerId)
            {
