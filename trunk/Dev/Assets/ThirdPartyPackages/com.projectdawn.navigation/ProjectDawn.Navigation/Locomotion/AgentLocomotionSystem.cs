...
namespace ProjectDawn.Navigation
{
    ...
    public partial struct AgentLocomotionSystem : ISystem
    {
        ...
        {
            //Debug.LogError($"{SystemAPI.Time.fixedDeltaTime} {SystemAPI.Time.DeltaTime}");
        ...
        partial struct AgentLocomotionJob : IJobEntity
        {
            ...
            public void Execute(ref LocalTransform transform, ref AgentBody body, in AgentLocomotion locomotion,
                in AgentShape shape)
            {
                if (body.IsStopped)
                    return;
                ...
                if (locomotion.AutoBreaking)
                {
                    ...
                    {
                        maxSpeed = math.lerp(locomotion.Speed * 0.25f, locomotion.Speed,
                            remainingDistance / breakDistance);
                    }
                }
                ...
                body.Velocity = math.lerp(body.Velocity, body.Force * maxSpeed,
                    math.saturate(DeltaTime * locomotion.Acceleration));
                ...
                if (shape.Type == ShapeType.Circle)
                {
                    ...
                    transform.Rotation = math.slerp(transform.Rotation, quaternion.RotateZ(-angle),
                ...
                else if (shape.Type == ShapeType.Cylinder)
                {
                    ...
                    transform.Rotation = math.slerp(transform.Rotation, quaternion.RotateY(angle),
                        DeltaTime * locomotion.AngularSpeed);
                }
            }
        }
