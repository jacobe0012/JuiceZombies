Shader "AllIn1SpriteShader/AllIn1Urp2dRendererTest"
{
    Properties
    {
        ...
        _ZTestMode ("Z Test Mode", Float) = 4   //177
    	_CullingOption ("Culling Option", float) = 0   //178

		[HideInInspector] _MinXUV("_MinXUV", Range(0, 1)) = 0.0   //179
		[HideInInspector] _MaxXUV("_MaxXUV", Range(0, 1)) = 1.0   //180
		[HideInInspector] _MinYUV("_MinYUV", Range(0, 1)) = 0.0   //181
		[HideInInspector] _MaxYUV("_MaxYUV", Range(0, 1)) = 1.0   //182
		[HideInInspector] _RandomSeed("_MaxYUV", Range(0, 10000)) = 0.0   //183
    	_EditorDrawers("Editor Drawers", Int) = 14   //184

		_JiYuFlip("JiYu Flip",Vector) = (0, 0, 0, 0)   //185
		_JiYuSort("JiYu Sort",Vector) = (0, 0, 0, 0)   //186
		_JiYuPivot("JiYu Pivot",Range(0, 1)) = 0.5   //187
    }
