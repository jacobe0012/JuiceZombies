...
public sealed partial class drop :  Bright.Config.BeanBase 
{
    ...
    public drop(int assist, int id, int pack_id, int pack_power, System.Collections.Generic.List<UnityEngine.Vector3> reward ) 
    {
        this.assist = assist;
        this.id = id;
        this.packId = pack_id;
    ...
    public static drop Deserializedrop(JSONNode _json)
    {
        return new config.drop(_json);
    }
    ...
    public const int __ID__ = -28205541;
