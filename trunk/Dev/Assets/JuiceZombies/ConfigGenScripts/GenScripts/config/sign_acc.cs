...
public sealed partial class sign_acc :  Bright.Config.BeanBase 
{
    public sign_acc(JSONNode _json) 
    {
    ...
    public sign_acc(int id, int day, System.Collections.Generic.List<UnityEngine.Vector3> reward ) 
    {
        this.id = id;
        this.day = day;
        this.reward = reward;
    ...
    public static sign_acc Deserializesign_acc(JSONNode _json)
    {
        return new config.sign_acc(_json);
    }
    ...
    public const int __ID__ = 1314019371;
