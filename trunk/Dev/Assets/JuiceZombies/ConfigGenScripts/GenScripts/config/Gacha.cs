...
public sealed partial class Gacha :  Bright.Config.BeanBase 
{
    ...
    public Gacha(int id, int time, string name, string desc, string icon, int sort, int price1, int price2, System.Collections.Generic.List<UnityEngine.Vector2> pool, int ensure_pool_id, int ensure_count ) 
    {
        this.id = id;
        this.time = time;
        this.name = name;
