...
namespace Main
{
    //怕黑
    //new 
    public partial struct Buff_999103 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        {
            if (inData.enviromentData.env.time == 201)
            {
                if (!isAtive)
                {
                    isAtive = true;
                    ...
                    var attRations = -monsterfeature.para[0];
                    var speedRations = -monsterfeature.para[1];
                    ...
                    Debug.Log($"103 isActive:time:{inData.enviromentData.env.time}");
                }
            }
            else
            {
