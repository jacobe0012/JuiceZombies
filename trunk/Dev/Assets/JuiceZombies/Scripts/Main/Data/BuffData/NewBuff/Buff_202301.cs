...
namespace Main
{
    //元素专用 地形水 障碍物油
    //new 
    public partial struct Buff_202301 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            var ins = refData.ecb.Instantiate(inData.sortkey, inData.prefabMapData.prefabHashMap["model_bullet_13000101"]);
            ...
            refData.ecb.AddComponent(inData.sortkey, ins, new TimeToDieData { duration = duration });
            refData.ecb.SetComponent(inData.sortkey, inData.entity, new ElementData { id = 204 });
