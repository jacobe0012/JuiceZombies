...
namespace Main
{
    //元素专用 地形水 障碍物电
    //new 
    public partial struct Buff_202303 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            ins = refData.ecb.Instantiate(inData.sortkey, inData.prefabMapData.prefabHashMap["model_bullet_30501101"]);
            ...
            refData.ecb.SetComponent(inData.sortkey, inData.entity, new ElementData { id = 203 });
        ...
        {
            if (refData.storageInfoFromEntity.Exists(ins))
            {
                refData.ecb.DestroyEntity(inData.sortkey, ins);
                refData.ecb.SetComponent(inData.sortkey, inData.entity, new ElementData { id = 202 });
            }
