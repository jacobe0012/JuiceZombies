...
namespace Main
{
    //灼烧-木    状态
    //new 
    public partial struct Buff_126 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
          ...
          public void OnTick(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            UnityEngine.Debug.LogError($"101OnTick{timeElapsed}  {tickTime}");
       ...
       public void OnKill(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        ...
        private void ChangeProp(ref BuffData_ReadWrite refData, BuffData_ReadOnly inData)
        {
            ...
            ref var battleStatesConfig = ref inData.globalConfigData.value.Value.configTbbattle_statuss.configTbbattle_statuss;
            int index = 0;
