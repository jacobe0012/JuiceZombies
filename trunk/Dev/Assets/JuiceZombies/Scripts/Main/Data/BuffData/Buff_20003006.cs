...
namespace Main
{
    ...
    /// 降低击退抗性  20003006
    /// </summary>
    public partial struct Buff_20003006 : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        {
            Debug.Log($"降低击退抗性 20003006");
            var prop = refData.cdfeChaStats[carrier].chaProperty;
            prop.reduceHitBackRatios = (int)(prop.reduceHitBackRatios * (1 - buffArgs.args0 / 10000f));
