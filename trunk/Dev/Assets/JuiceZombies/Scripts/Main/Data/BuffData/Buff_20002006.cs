...
// {
//     //幻影形态
//     public partial struct Buff_20002006 : IBuffOld
//     {
//         ///<summary>0
//         ///buff的id
//         ///</summary>
...
//
//             temp.chaResource.isInvincible = true;
//
...
//             var collider = PhysicsHelper.CreateColliderWithCollidesWith(physicsCollider, 6);
//
//             refData.ecb.SetComponent(inData.sortkey, carrier, collider);
//         }
//
...
//             var temp = refData.cdfeChaStats[carrier];
//
//             temp.chaResource.isInvincible = false;
//
//             refData.cdfeChaStats[carrier] = temp;
//
//             var physicsCollider = refData.cdfePhysicsCollider[carrier];
//             var collider = PhysicsHelper.CreateColliderWithCollidesWith(physicsCollider, oldFilter);
//
//             refData.ecb.SetComponent(inData.sortkey, carrier, collider);
//         }
//
