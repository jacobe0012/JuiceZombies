...
namespace Main
{
    ...
    ///增伤buff 可合并不可叠加
    /// </summary>
    public partial struct Buff_20003008 : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        {
            //ref var skillArray = ref inData.globalConfigData.value.Value.configTbskill_effects.configTbskill_effects;
            //var buff = BuffHelper.UpdateParmeter(inData.globalConfigData, buffArgs.args0, id);
            //duration = buff[1].x / 1000f;
            //buffArgs.args1 = buff[0].x;
        ...
        {
            var damage = refData.damageInfo.damage;
            damage.normal *= buffArgs.args1;
            // damage.collide *= buffArgs.args1;
            // damage.bullet *= buffArgs.args1;
            // damage.environment *= buffArgs.args1;
            refData.damageInfo.damage = damage;
        }
