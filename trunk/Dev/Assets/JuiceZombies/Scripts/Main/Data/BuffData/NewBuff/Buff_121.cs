...
namespace Main
{
    //隐身    状态
    //new 
    public partial struct Buff_121 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            if (refData.cdfeChaStats.HasComponent(carrier))
            {
                ...
                temp.chaImmuneState.immunePush = true;
                temp.chaImmuneState.immuneDamage = true;
                temp.chaImmuneState.immuneControl = true;
        ...
        public void OnRemoved(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            {
                var temp = refData.cdfeChaStats[carrier];
                temp.chaImmuneState.immunePush = false;
                temp.chaImmuneState.immuneDamage = false;
                temp.chaImmuneState.immuneControl = false;
                refData.cdfeChaStats[carrier] = temp;
            }
        }
