...
namespace Main
{
    //杀人机器
    //new 
    public partial struct Buff_999102 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            tickTime = (int)(monsterfeature.para[0]/1000/inData.fdT);
        ...
        public void OnTick(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            if(level< maxLevel)
            {
                Debug.Log($"102 isActive, attRations:{attRations}");
                UnityHelper.ChangeProperty(ref refData.ecb, inData.sortkey, ref refData.cdfeChaStats,
                    ref refData.cdfePlayerData, ref refData.cdfePhysicsMass, refData.cdfeLocalTransform, 203020, attRations, carrier);
                level++;
            }
