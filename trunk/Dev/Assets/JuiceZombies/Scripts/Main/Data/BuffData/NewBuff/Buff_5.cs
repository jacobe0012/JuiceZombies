...
{
    //免疫类 
    public partial struct Buff_5 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            int immuneType = argsNew.args1.x;
            var state = refData.cdfeChaStats[carrier].chaImmuneState;
            switch (immuneType)
            {
                case 1:
                    ...
                    break;
                case 2:
                    //state.immuneBuff = true;
                    break;
                case 3:
                    //state.immuneDeBuff = true;
                    break;
            }

            var stats = refData.cdfeChaStats[carrier];

            stats.chaImmuneState = state;
