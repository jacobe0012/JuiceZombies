...
namespace Main
{
    //元素专用 障碍物木 技能水
    //new 
    public partial struct Buff_102302 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            tickTime = (int)(argsNew.args1.x/1000f/inData.fdT);
        ...
        {
            Debug.LogError("DamageInfoDamageInfoDamageInfoDamageInfo   0000000000000");
            if (!refData.cdfeChaStats.HasComponent(carrier)) return;
            ...
            damage.normal = -(int)math.floor(refData.cdfeChaStats[carrier].chaProperty.maxHp*argsNew.args1.y/10000f);

            Debug.LogError("DamageInfoDamageInfoDamageInfoDamageInfo   ");
            //TODO:暴击率
