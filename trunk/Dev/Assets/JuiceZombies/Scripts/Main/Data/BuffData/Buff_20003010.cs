...
namespace Main
{
    ...
    public partial struct Buff_20003010 : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnTick(ref BuffOldData_ReadWrite refData, in BuffOldData_ReadOnly inData)
        {
            ...
            {
                // damage.environment = (int)math.floor(refData.cdfeChaStats[inData.player]
                //                                          .chaProperty.maxHp *
                //                                      buffArgs.args0 /
                //                                      10000f);
            }
            ...
            {
                damage.normal = (int)math.floor(refData.cdfeChaStats[inData.player]
                                                    .chaProperty.maxHp *
                                                buffArgs.args0 /
                                                10000f);
                attaker = caster;
