...
namespace Main
{
    //造成伤害后 移动速度加成 加等 args0为加成值
    public partial struct Buff_SKill_403023 : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        {
            refData.ecb.AppendToBuffer(inData.sortkey, carrier, new Buff_10207020
            {
                id = id,
                priority = 0,
                maxStack = 0,
