...
{
    //控制类型 
    public partial struct Buff_4 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            duration = argsNew.args2.x / 1000f;

            
            var state = refData.cdfeChaStats[carrier].chaControlState;
            switch (argsNew.args1.x)
            {
                case 1:
                    state.cantWeaponAttack = true;
                    state.cantMove = true;
                    break;
                case 2:
                    state.cantMove = true;
                    break;
                case 3:
                    state.counterMove = true;
                    break;
                case 4:
                    state.restrictView = true;
                    break;
                //case 5:
                //    //state.fear = true;
                //    //break;
                //case 6:
                //    state.rangeHold = true;
                //    break;
            }

            var stats = refData.cdfeChaStats[carrier];

            stats.chaControlState = state;
            refData.cdfeChaStats[carrier] = stats;
        }
        ...
        public void OnRemoved(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            {
                case 1:
                    state.cantWeaponAttack = false;
                    state.cantMove = false;
                    break;
                case 2:
                    state.cantMove = false;
                    break;
                case 3:
                    state.counterMove = false;
                    break;
                case 4:
                    state.restrictView = false;
                    break;
                //case 5:
                //    state.fear = 0;
                //    break;
