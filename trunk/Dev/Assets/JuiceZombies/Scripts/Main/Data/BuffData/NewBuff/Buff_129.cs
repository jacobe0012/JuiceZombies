...
namespace Main
{
    //固定低移速   状态
    //new 
    public partial struct Buff_129 : IBuff
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            oldspeedRations = refData.cdfeChaStats[carrier].chaProperty.maxMoveSpeedRatios;
            oldspeed = refData.cdfeChaStats[carrier].chaResource.curMoveSpeed;

            var temp = refData.cdfeChaStats[carrier];
            temp.chaResource.curMoveSpeed = argsNew.args1.x;
            temp.chaProperty.maxMoveSpeedRatios = 0;
        ...
        public void OnRemoved(ref BuffData_ReadWrite refData, in BuffData_ReadOnly inData)
        {
            ...
            var temp = refData.cdfeChaStats[carrier];
            temp.chaResource.curMoveSpeed = oldspeed;
            temp.chaProperty.maxMoveSpeedRatios = oldspeedRations;
            refData.cdfeChaStats[carrier] = temp;
        }
