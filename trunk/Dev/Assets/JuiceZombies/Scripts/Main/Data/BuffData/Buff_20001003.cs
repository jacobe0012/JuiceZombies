...
namespace Main
{
    ...
    /// 加速
    /// </summary>
    public partial struct Buff_20001003 : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        public void OnOccur(ref BuffOldData_ReadWrite refData, in BuffOldData_ReadOnly inData)
        {
            ...
            temp.chaProperty.speedRecoveryTime =
                (int)(temp.chaProperty.speedRecoveryTime * (1 - buffArgs.args0 / 10000f));
