...
namespace Main
{
    ...
    /// 减速(可叠加)
    /// </summary>
    public partial struct Buff_20003007 : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        {
            buffStack.stack++;
            Debug.Log($"减速 可叠加 20003007");
            var prop = refData.cdfeChaStats[carrier].chaProperty;
            prop.maxMoveSpeed = prop.maxMoveSpeed * (1 - buffArgs.args0);
            prop.speedRecoveryTime = prop.speedRecoveryTime * (1 + buffArgs.args0);
            //prop.stallAcceleration = prop.stallAcceleration * (1 - buffArgs.args0);
