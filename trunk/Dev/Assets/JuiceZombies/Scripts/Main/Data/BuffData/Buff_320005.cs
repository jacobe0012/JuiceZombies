...
// {
//     //升级回复生命
//     public partial struct Buff_320005 : IBuffOld
//     {
//         ///<summary>0
//         ///buff的id
//         ///</summary>
...
//         {
//             if (refData.cdfePlayerData[inData.entity].playerData.killEnemy % buffArgs.args0 == 0)
//             {
//             }
//         }
//
...
//         {
//             int buffArgs0 = 0, buffArgs1 = 0;
//             ref var skillEffect = ref inData.globalConfigData.value.Value.configTbskill_effects.configTbskill_effects;
//             for (int i = 0; i < skillEffect.Length; i++)
//             {
//                 if (skillEffect[i].id == id)
//                 {
//                     buffArgs0 = skillEffect[i].buff1Para[0];
//                     buffArgs1 = skillEffect[i].buff1Para[1];
//                     break;
//                 }
//             }
//
...
//                 new Buff_30000020
//                 {
//                     carrier = carrier, duration = 0, buffArgs = new BuffArgs { args0 = buffArgs0, args1 = buffArgs1 },
//                     permanent = false, caster = caster
//                 }.ToBuffOld());
//         }
//     }
// }
