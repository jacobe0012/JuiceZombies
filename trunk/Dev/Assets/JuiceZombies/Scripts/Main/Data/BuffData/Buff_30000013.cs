...
namespace Main
{
    //造成伤害(可叠加) 300000031    环境伤害 
    public partial struct Buff_300000031 : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        {
            //Debug.Log($"OnTick:{timeElapsed}");
            buffStack.stack++;
            Entity attaker = default;
            var damageValue = 1 * buffStack.stack;
            var damage = new Damage
            {
                normal = 0,
                // bullet = 0,
                // collide = 0,
                // environment = damageValue
            };
