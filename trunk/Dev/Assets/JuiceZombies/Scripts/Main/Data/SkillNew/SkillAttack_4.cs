...
{
    //跟随作用方移动的弹幕
    public partial struct SkillAttack_4 : ISkillAttack
    {
        /// <summary>
        /// 0
        /// </summary>
        ...
        public LocalTransform DoSkillMove(ref SkillAttackData_ReadWrite refData, in SkillAttackData_ReadOnly inData)
        {
            ...
            var targetPos = refData.cdfeLocalTransform[caster].Position;
        ...
        {
            BuffHelper.AddTriggerForDeathBullet(ref refData, in inData, inData.sortkey, deadEffectID, caster,
                defaultDir);
        }
            ...
            int sortkey, int triggerID, Entity caster)
        {
            ...
            var rand = Random.CreateFromIndex((uint)(inData.timeTick + caster.Index + caster.Version));
