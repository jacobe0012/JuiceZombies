...
//    /// 巨型磁铁的技能逻辑
//    /// </summary>
//    public partial struct Skill_100401 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            if (!BuffHelper.TryGetParmeter(inData.globalConfig, currentSkillEffectID, 40000013)) return;
//            var buff1 = BuffHelper.UpdateParmeter(inData.globalConfig, currentSkillEffectID, 40000013);
//            var radius = buff1[1].x * (1 + inData.cdfeChaStats[inData.entity].chaProperty.skillRangeRatios *
//                (buff1[1].z / 10000f));
//            float duration = buff1[0].x / 1000f;

//            if (!BuffHelper.TryGetParmeter(inData.globalConfig, currentSkillEffectID, 50000001)) return;
//            var buff2 = BuffHelper.UpdateParmeter(inData.globalConfig, currentSkillEffectID, 50000001);
//            var offset = buff2[1].x;
...
//            if (BuffHelper.JudgeEquipExist(inData.entity,inData.bfePlayerEquipSkillBuffer, 401033, inData.globalConfig, out int skillEffectID))
//            {
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 20002012))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 20002012);
//                    radius*=(1+ buff[1].x /10000f) ;
//                }
//            }
