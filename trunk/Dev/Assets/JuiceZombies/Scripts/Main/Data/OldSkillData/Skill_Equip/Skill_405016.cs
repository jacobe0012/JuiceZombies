...
//    ///武器推力增强15%
//    /// </summary>
//    public partial struct Skill_405016 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            {
//                int additon = 0;
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10109000))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10109000);
//                    additon = buff[1].x;
//                }

//                refData.ecb.AppendToBuffer(inData.sortkey, inData.entity, new Buff_10109000
//                {
//                    id = 10213000,
//                    priority = 0,
//                    maxStack = 0,
