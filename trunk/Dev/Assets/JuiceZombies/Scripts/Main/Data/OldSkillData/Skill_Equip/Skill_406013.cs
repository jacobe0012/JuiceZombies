...
//    ///移动一定距离生成诱饵
//    /// </summary>
//    public partial struct Skill_406013 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            if (BuffHelper.JudgeEquipExist(inData.entity, inData.bfePlayerEquipSkillBuffer, id, inData.globalConfig,
//                    out int skillEffectID))
//            {
//                int moveDis = 0, attackDuration = 0;
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 50000006))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 50000006);
//                    moveDis = buff[1].x;
//                }

//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 30000028))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 30000028);
//                    attackDuration = buff[0].x;
//                }

//                refData.ecb.AppendToBuffer(inData.sortkey, inData.entity,
//                    new Buff_50000006_406013
//                    {
//                        id = 406013,
//                        priority = 0,
//                        maxStack = 0,
...
//                        canBeStacked = false,
//                        buffStack = default,
//                        buffArgs = new BuffArgs { args0 = attackDuration },
//                        totalMoveDistance = 0,
//                        xMetresPerInvoke = moveDis,
