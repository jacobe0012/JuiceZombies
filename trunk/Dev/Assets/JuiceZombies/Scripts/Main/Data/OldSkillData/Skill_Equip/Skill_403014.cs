...
//    ///连续撞击额外造成伤害
//    /// </summary>
//    public partial struct Skill_403014 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            {
//                int additon = 0;
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10118200))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10118200);
//                    additon = buff[1].x;
//                }

//                refData.ecb.AppendToBuffer(inData.sortkey, inData.entity, new Buff_10118200
//                {
//                    id = 10118100,
//                    priority = 0,
//                    maxStack = 0,
