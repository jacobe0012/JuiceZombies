...
//    ///加速度时间减少30%
//    /// </summary>
//    public partial struct Skill_406024 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            {
//                int addtion=0;
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10207100))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10207100);
//                    addtion = buff[1].x;
//                }
//                if (BuffHelper.JudgeEquipExist(inData.entity,inData.bfePlayerEquipSkillBuffer, 406026, inData.globalConfig, out skillEffectID))
//                {
//                    if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10207100))
//                    {
//                        var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10207100);
...
//                        canBeStacked = false,
//                        buffStack = default,
//                        buffArgs = new BuffArgs { args0= addtion },
//                        totalMoveDistance = 0,
