...
//    /// 生成诱饵
//    /// </summary>
//    public partial struct SkillAttack_4060131 : ISkillAttack
//    {
//        /// <summary>
//        /// 0
//        /// </summary>
...
//            return refData.cdfeLocalTransform[inData.player];
...
//                var buff= BuffHelper.UpdateParmeter(inData.config, id, 40000010);
//                var scale=buff[2].x;
//                var pushRate = buff[3].x;
//                var buff1 = BuffHelper.UpdateParmeter(inData.config, id, 30000003);
...
//                {
//                    buffID = 40000003,
//                    buffArgs = new float3x4 { c0 = new float3(pushRate, 0, 0) }
//                });
//                refData.ecb.AppendToBuffer(inData.sortkey, ins, new SkillHitEffectBuffer
//                {
//                    buffID = 30000003,
...
//            {
//                var dis = math.distance(refData.cdfeLocalTransform[inData.allEntities[i]].Position, refData.cdfeLocalTransform[inData.player].Position);
//                if (dis < 10f)
//                {
//                    refData.cdfeAgentBody[inData.allEntities[i]].SetDestination(refData.cdfeLocalTransform[inData.player].Position);
//                }
//            }
//        }
//    }
