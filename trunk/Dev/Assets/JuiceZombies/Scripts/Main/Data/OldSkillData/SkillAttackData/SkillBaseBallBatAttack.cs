...
//{
//    //棒球棍
//    public partial struct SkillBaseBallBatAttack : ISkillAttack
//    {
//        /// <summary>
//        /// 0
//        /// </summary>
...
//            float degreePerFrame = diffuseSpeed / 50 * actionspeed;
//            float radiansPerFrame = math.radians(degreePerFrame);
//            if (diffuseDirection == 2)
//            {
...
//            var newq = newLoc.RotateZ(radiansPerFrame);
...
//        {
//            if (BuffHelper.JudgeEquipExist(inData.entity, inData.bfePlayerEquipSkillBuffer, 401016, inData.config,
//                    out int skillEffectID))
//            {
//                var buff = BuffHelper.UpdateParmeter(inData.config, skillEffectID, 40000003);
//                var angle = buff[1].x;
//                var scale = buff[2].x;
...
//                var qua = PhysicsHelper.SetTrans(inData.allEntities, refData.cdfeLocalTransform,
//                    inData.cdfeChaStats, inData.cdfePlayerData, inData.cdfeEnemyData, inData.cdfeSpiritData,
//                    inData.cdfeObstacleTag,
//                    inData.entity, TargetAttackType.Enemy, BuffHelper.GetDistanceToEnemy(inData.config, skillEffectID),
//                    angle);
//                var enemyLoc = new LocalTransform
//                {
//                    Position = refData.cdfeLocalTransform[inData.player].Position,
//                    Scale = scale * refData.cdfeLocalTransform[skillBaseBallBat].Scale,
//                    Rotation = qua,
//                };
...
//                //{
//                //    data = new SkillAttack_40000003
//                //    {
//                //        id = skillEffectID,
//                //        angle = angle,
//                //        diffuseSpeed = diffuseSpeed,
//                //        duration = angle / diffuseSpeed,
//                //        scale = scale,
//                //        tick = 0,
