...
//    ///受伤生成烟雾弹 有持续时间和冷却
//    /// </summary>
//    public partial struct Skill_402013 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            {
//                float buffDuration = 0, buffCooldown = 0,scale=0;
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 30000017))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 30000017);
//                    buffDuration = buff[0].x;
//                    scale = buff[1].x;
//                    buffCooldown = 60f;
//                }

//                if (BuffHelper.JudgeEquipExist(inData.entity,inData.bfePlayerEquipSkillBuffer, 402014, inData.globalConfig, out skillEffectID))
//                {
//                    buffCooldown = 30f;
//                }
//                if (BuffHelper.JudgeEquipExist(inData.entity,inData.bfePlayerEquipSkillBuffer, 402014, inData.globalConfig, out skillEffectID))
...
//                     new Buff_30000017 {id= 30000017,caster=default, carrier = inData.entity, duration = 1,permanent=true,tickTime=buffCooldown,buffArgs=new BuffArgs {args0=(int)scale,args1=(int)buffDuration } }.ToBuffOld());
