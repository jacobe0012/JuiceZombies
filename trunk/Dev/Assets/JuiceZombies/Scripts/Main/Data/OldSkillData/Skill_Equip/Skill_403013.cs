...
//    ///撞击额外造成伤害
//    /// </summary>
//    public partial struct Skill_403013 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            {
//                int additon = 0;
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10118100))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10118100);
//                    additon = buff[1].x;
//                }

//                if (BuffHelper.JudgeEquipExist(inData.entity,inData.bfePlayerEquipSkillBuffer, 402016, inData.globalConfig, out skillEffectID))
//                {
//                    if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10118100))
//                    {
//                        var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10118100);
...
//                    }
//                }
//                refData.ecb.AppendToBuffer(inData.sortkey, inData.entity, new Buff_10118100
//                {
//                    id = 10118100,
//                    priority = 0,
//                    maxStack = 0,
