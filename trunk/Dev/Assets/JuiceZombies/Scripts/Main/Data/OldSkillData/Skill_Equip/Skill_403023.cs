...
//    ///造成伤害后移动速度增加
//    /// </summary>
//    public partial struct Skill_403023 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//            {
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10207020))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10207020);
//                    buffduration = buff[0].x;
//                    additon = buff[1].x;
//                }
//            }
//            if(BuffHelper.JudgeEquipExist(inData.entity,inData.bfePlayerEquipSkillBuffer,403025,inData.globalConfig,out  skillEffectID))
//            {
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 10207020))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 10207020);
...
//                }
//            }
//            refData.ecb.AppendToBuffer(inData.sortkey, inData.entity, new Buff_SKill_403023()
//            {
//                id = id,
//                priority = 0,
//                maxStack = 0,
...
//                }
//            }.ToBuffOld());
//            if(BuffHelper.JudgeEquipExist(inData.entity,inData.bfePlayerEquipSkillBuffer,403026,inData.globalConfig,out  skillEffectID))
//            {
//                if (BuffHelper.TryGetParmeter(inData.globalConfig, skillEffectID, 20001005))
//                {
//                    var buff = BuffHelper.UpdateParmeter(inData.globalConfig, skillEffectID, 20001005);
//                    additon = buff[1].x;
//                }
//                refData.ecb.AppendToBuffer(inData.sortkey, inData.entity, new Buff_20001005()
//                {
//                    id = id,
//                    priority = 0,
//                    maxStack = 0,
