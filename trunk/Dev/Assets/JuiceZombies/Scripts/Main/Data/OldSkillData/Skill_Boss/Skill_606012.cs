...
//    /// boss技能----加速移动
//    /// </summary>
//    public partial struct Skill_606012 : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//                }
//            }
//            if (!BuffHelper.TryGetParmeter(inData.globalConfig, currentSkillEffectID,out var buff, 40000005)) return;
//            var buffDuration = buff[0].x / 1000f;
//            var buffAddtion = buff[1].x;

//            refData.ecb.AppendToBuffer(inData.sortkey, caster, new Buff_10207020
//            {
//                id = 10207020,
//                priority = 0,
//                maxStack = 0,
...
//            if (!BuffHelper.TryGetParmeter(inData.globalConfig, currentSkillEffectID, out var buff1, 50000018)) return;
//            var delayTime = buff1[0].x / 1000f;

//            if (!BuffHelper.TryGetParmeter(inData.globalConfig, currentSkillEffectID, out var buff2, 40000003)) return;
//            var scale = buff2[2].x;

//            var skillPrefab = inData.prefabMapData.prefabHashMap["SectorATKRangePrefab"];
...
//            var playerLoc= SetTransToPlayer(inData, 9999);
//            playerLoc.Scale = inData.cdfeLocalTransform[skillPrefab].Scale * scale;
//            playerLoc.Position = inData.cdfeLocalTransform[caster].Position;
//            refData.ecb.SetComponent(inData.sortkey, skillEntity, playerLoc);
...
//            //GetRandOffsetPos(ref refData, inData, distance, target);
