...
//    ///鞭炮(旧版)
//    /// </summary>
//    public partial struct Skill_210601_diy : ISkillOld
//    {
//        ///<summary>0
//        ///技能的id
//        ///</summary>
...
//                {
//                    GenerateFireCrecker(timeArray[i], ref refData, inData,range,scale,i);
//                }
...
//        private void GenerateFireCrecker(int tick,ref TimeLineData_ReadWrite refData,TimeLineData_ReadOnly inData,int range,float scale,int i)
//        {
...
//            var targetPos = GetRandOffsetPos(ref refData, inData, range+offset, target, i);
...
//            {
//                data = new SkillAttack_Throw210601_diy
//                {
