...
namespace Main
{
    ...
    ///获得羁绊经验
    /// </summary>
    public partial struct GameEvent_54 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        private void GetBindingExp(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
        ...
        {
            GetBindingExp(ref refData, inData);
        }
