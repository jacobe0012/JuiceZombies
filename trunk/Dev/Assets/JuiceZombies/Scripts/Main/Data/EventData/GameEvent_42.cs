...
namespace Main
{
    ...
    ///商店开启后，角色触发技能
    /// </summary>
    public partial struct GameEvent_42 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        {
            AddSkillForOpen(ref refData, inData);
        }

        private void AddSkillForOpen(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            isActive = true;
