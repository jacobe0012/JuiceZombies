...
namespace Main
{
    ...
    ///事件类型 23 刷新指定id怪物
    /// </summary>
    public partial struct GameEvent_999026 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        private void GenerateItem(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            ...
            {
                //TODO:正反遍历
                if (tbmonster_templates[i].id == args123.y && tbmonster_templates[i].ruleId == args123.z)
                {
            ...
            var defaultAtk = monster_template.atk;
            var defaultMaxHp = monster_template.hp;
