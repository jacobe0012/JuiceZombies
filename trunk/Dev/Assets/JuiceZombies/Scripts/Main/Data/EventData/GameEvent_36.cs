...
namespace Main
{
    ...
    ///获得随机羁绊技能
    /// </summary>
    public partial struct GameEvent_36 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        {
            GetRandomTieSkill(ref refData, inData);
        }

        private void GetRandomTieSkill(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
