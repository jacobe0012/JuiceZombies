...
namespace Main
{
    ...
    ///警报
    /// </summary>
    public partial struct GameEvent_44 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        {
            DisplayShop(ref refData, inData);
        }

        private void DisplayShop(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            ...
            UnityHelper.TryCreateAudioClip(inData.config, inData.gameOthersData, audioId,out var _);
        }
