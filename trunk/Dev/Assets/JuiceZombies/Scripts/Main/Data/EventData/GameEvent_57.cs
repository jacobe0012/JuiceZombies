...
{
    /// <summary>
    ///每刷新【参数1】次，获得【参数2】次刷新次数
    /// </summary>
    public partial struct GameEvent_57 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        private void  AddSkillForEndStag(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            UnityEngine.Debug.Log("999999999999999999999999999999");
            isActive = true;
        }
        ...
        {
            AddSkillForEndStag(ref refData, inData);
        }
