...
{
    /// <summary>
    ///每购买【参数1】次技能，随机获得一个当前羁绊经验最高的羁绊技能。
    /// </summary>
    public partial struct GameEvent_40 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        public void OnOccur(ref GameEventData_ReadWrite refData, in GameEventData_ReadOnly inData)
        {
            ...
            ChangeNeedSkillCount(ref refData, inData);
        }

        private void ChangeNeedSkillCount(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            isActive = true;
            //if (refData.cdfePlayerData.HasComponent(inData.selefEntity))
            //{
            //    var temp = refData.cdfePlayerData[inData.selefEntity];
            //    temp.playerotherData.buySkillCout.y = args123.x;
