...
namespace Main
{
    ...
    ///变更镜头高度
    /// </summary>
    public partial struct GameEvent_33 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        {
            ChangeCameraHeight(ref refData, inData);
        }

        private void ChangeCameraHeight(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
