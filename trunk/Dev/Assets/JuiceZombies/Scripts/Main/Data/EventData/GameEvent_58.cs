...
{
    /// <summary>
    ///每刷新【参数1】次，获得【参数2】个蓝色技能
    /// </summary>
    public partial struct GameEvent_58 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        private void  AddSkillForRefreshShop(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            isActive = true;
        }
        ...
        {
            AddSkillForRefreshShop(ref refData, inData);
        }
