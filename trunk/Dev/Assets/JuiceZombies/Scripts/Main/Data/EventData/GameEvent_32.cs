...
namespace Main
{
    ...
    ///科技选择
    /// </summary>
    public partial struct GameEvent_32 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        {
            SelectTch(ref refData, inData);
        }

        private void SelectTch(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            ...
            UnityHelper.TryCreateAudioClip(inData.config, inData.gameOthersData, 2202,out var _);
        }
