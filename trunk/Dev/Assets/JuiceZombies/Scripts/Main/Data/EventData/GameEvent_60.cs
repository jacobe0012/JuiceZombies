...
{
    /// <summary>
    ///角色累计获得【参数1】万分比*【参数3】羁绊总经验的【参数2】属性变更
    /// </summary>
    public partial struct GameEvent_60 : IGameEvent
    {
        /// <summary>
        ///事件id 0
        /// </summary>
        ...
        private void ChangePropertyRelatSkillCount(ref GameEventData_ReadWrite refData, GameEventData_ReadOnly inData)
        {
            ...
            {
                type = 10,
                args = new float4(args123.x, args123.z, args123.y, 0f)
            });
        ...
        public void OnEventRemove(ref GameEventData_ReadWrite refData, in GameEventData_ReadOnly inData)
        {
            UnityHelper.RemoveChangeProperty(ref refData.ecb, inData.sortKey, ref refData.cdfeChaStats,
                ref refData.cdfePlayerData, ref refData.cdfePhysicsMass, inData.cdfeLocalTransform, args123.y,
                skillCount * args123.x, inData.selefEntity);
        }
