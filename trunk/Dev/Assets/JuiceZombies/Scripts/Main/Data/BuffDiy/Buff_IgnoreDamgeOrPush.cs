...
{
    //无视某个技能的碰撞或者伤害
    public partial struct Buff_IgnoreDamgeOrPush : IBuffOld
    {
        ///<summary>0
        ///buff的id
        ///</summary>
        ...
        {
            Debug.Log($"无视id为{buffArgs.args0}的技能");
            //Debug.Log($"无敌");
            ...
            //var physicsCollider =inData.cdfePhysicsCollider[carrier];
            //oldFilter = physicsCollider.Value.Value.GetCollisionFilter().CollidesWith;
            //PhysicsCollider newCollider =
            //    PhysicsHelper.CreateColliderWithBelongsTo(physicsCollider,6);
            refData.ecb.AddComponent(inData.sortkey, carrier, new IgnoreHitBackData { IgnoreType = buffArgs.args1 });
        }
        ...
        public void OnRemoved(ref BuffOldData_ReadWrite refData, in BuffOldData_ReadOnly inData)
        {
            ...
            //var physicsCollider = inData.cdfePhysicsCollider[carrier];
            //PhysicsCollider newCollider =
            //    PhysicsHelper.CreateColliderWithBelongsTo(physicsCollider, oldFilter);
            //refData.ecb.SetComponent(inData.sortkey, carrier, newCollider);
            refData.ecb.RemoveComponent<IgnoreHitBackData>(inData.sortkey, carrier);
        }
