namespace HotFix_UI
{
    public static class JuiceZombieCMD
    {

        public const int QueryMonCard = (MainCmd.shopCmd << 16) + ShopCmd.queryMonCard;
        #region old
        ////0,1   登录
        ...
        {
            public const int queryMonCard = 1;
