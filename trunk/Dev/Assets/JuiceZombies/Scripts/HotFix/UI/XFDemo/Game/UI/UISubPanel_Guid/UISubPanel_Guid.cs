...
namespace XFramework
{
    ...
    public partial class UISubPanel_Guid : UI, IAwake<int>, IAwake<int, int>
    {
        ...
        async UniTaskVoid InitNode()
        {
            ...
            // //         // if (guide.id == 3)
            // //         // {
            // //         //     //KTxt_Des.GetTextMeshPro().SetTMPText("��ײ������nokey");
            // //         //
            // //         //     await UniTask.Delay(3000);
            // //         //     UnicornUIHelper.FinishGuide(guide.id);
            // //         //     Close();
            ...
            // //         // else if (guide.id == 4)
            // //         // {
            // //         //     //KTxt_Des.GetTextMeshPro().SetTMPText("��������˵�ĳЩ�ϰ����Ͽɲ�����ײ����������˺���nokey");
            // //         //     await UniTask.Delay(3000);
            // //         //     UnicornUIHelper.FinishGuide(guide.id);
            // //         //     Close();
            // //         // }
            ...
            // //         // else if (guide.id == 6)
            // //         // {
            // //         //     //KTxt_Des.GetTextMeshPro().SetTMPText("����������Ҿ���ĵ���nokey");
            // //         //     await UniTask.Delay(3000);
            // //         //     UnicornUIHelper.FinishGuide(guide.id);
            // //         //     Close();
            // //         // }
            // //         // else if (guide.id == 7)
            // //         // {
            // //         //     //KTxt_Des.GetTextMeshPro().SetTMPText("����-����b nokey");
            // //         //     await UniTask.Delay(3000);
            // //         //     UnicornUIHelper.FinishGuide(guide.id);
            // //         //     Close();
            // //         // }
            ...
            // //         else
            // //         {
            // //             Log.Error($"guide.id {guide.id} �ؼ��ֶ�û�����û�δʵ��");
            // //             guideId = 0;
            // //             Close();
            // //         }
            // //
