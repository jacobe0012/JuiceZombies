...
namespace SuperScrollView
{
    public class ButtonPanelTreeViewSticky
    {
        ...
        public void Start()
        {
            ...
            mScrollToInputItem = GameObject.Find("ButtonPanel/ButtonGroupScrollTo/ScrollToInputFieldItem")
                .GetComponent<InputField>();
            mScrollToInputChild = GameObject.Find("ButtonPanel/ButtonGroupScrollTo/ScrollToInputFieldChild")
                .GetComponent<InputField>();

            mExpandAllButton = GameObject.Find("ButtonPanel/ButtonGroupExpandAll/ExpandAllButton")
                .GetComponent<Button>();
            mExpandAllButton.onClick.AddListener(OnExpandAllButtonClicked);

            mCollapseAllButton = GameObject.Find("ButtonPanel/ButtonGroupCollapseAll/CollapseAllButton")
                .GetComponent<Button>();
            ...
            mAddInputChild = GameObject.Find("ButtonPanel/ButtonGroupAdd/AddInputFieldChild")
                .GetComponent<InputField>();
