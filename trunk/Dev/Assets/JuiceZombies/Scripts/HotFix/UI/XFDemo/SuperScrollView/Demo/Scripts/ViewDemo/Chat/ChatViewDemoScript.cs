...
namespace SuperScrollView
{
    public class ChatViewDemoScript : MonoBehaviour
    {
        ...
        void InitButtonPanel()
        {
            ...
            mAppendUser1Button = GameObject.Find("ButtonPanel/ButtonGroupAppend/AppendUser1Button")
                .GetComponent<Button>();
            mAppendUser1Button.onClick.AddListener(OnAppendUser1ButtonClicked);
            mAppendUser2Button = GameObject.Find("ButtonPanel/ButtonGroupAppend/AppendUser2Button")
                .GetComponent<Button>();
