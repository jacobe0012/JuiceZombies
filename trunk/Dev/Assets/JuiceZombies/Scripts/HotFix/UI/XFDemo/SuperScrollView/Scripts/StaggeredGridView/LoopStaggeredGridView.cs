...
namespace SuperScrollView
{
    ...
    */
    ...
    public class LoopStaggeredGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        {
            get { return mListUpdateCheckFrameCount; }
        }
        ...
        */
        ...
        void UpdateLayoutParamAutoValue()
        {
            if (mLayoutParam.mCustomColumnOrRowOffsetArray == null)
            {
                ...
                if (IsVertList)
                {
                    itemPadding = (ViewPortWidth - mLayoutParam.mPadding1 - mLayoutParam.mPadding2 - itemTotalSize) /
                                  (mGroupCount - 1);
                }
                else
                {
                    itemPadding = (ViewPortHeight - mLayoutParam.mPadding1 - mLayoutParam.mPadding2 - itemTotalSize) /
                                  (mGroupCount - 1);
                }
        ...
        */
            ...
            float distanceForNew1)
        {
            ...
            while (needContinueCheck)
            {
                ...
                needContinueCheck = mItemGroupList[groupIndex].UpdateListViewPart2(distanceForRecycle0,
