    ...
    public class TreeViewSimpleDemoScript : MonoBehaviour
    {
        ...
        LoopListViewItem2 OnGetItemByIndex(LoopListView2 listView, int index)
        {
            ...
            */
            ...
            TreeViewItemData<SimpleItemData>
                treeViewItemData = mTreeViewDataSourceMgr.GetItemDataByIndex(treeItemIndex);
            ...
            else // if is a TreeChildItem
            {
                ...
                itemScript.SetItemSelected(mCurrentSelectIndex == childIndex);
                return item;
            }
        }
