...
namespace SuperScrollView
{
    ...
    public class LoopGridView : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        [SerializeField] List<GridViewItemPrefabConfData> mItemPrefabDataList = new List<GridViewItemPrefabConfData>();
        ...
        {
            get { return mItemSizeWithPadding; }
        }
        ...
        */
        ...
        void UpdateSnapMove(bool immediate = false, bool forceSendEvent = false)
        {
            ...
            if (immediate || Mathf.Abs(mCurSnapData.mTargetSnapVal - mCurSnapData.mCurSnapVal) < mSnapFinishThreshold)
            {
                ...
                {
                    LoopGridViewItem targetItem = GetShownItemByRowColumn(mCurSnapNearestItemRowColumn.mRow,
        ...
        void UpdateCurSnapData()
        {
            ...
            {
                LoopGridViewItem nearestItem = GetShownItemByRowColumn(mCurSnapNearestItemRowColumn.mRow,
                    mCurSnapNearestItemRowColumn.mColumn);
                if (nearestItem == null)
                {
                    return;
