...
namespace SuperScrollView
{
    public class ResponsiveViewRefreshLoadDemoScript : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            mScrollToInput = GameObject.Find("ButtonPanel/ButtonGroupScrollTo/ScrollToInputField")
        ...
        void UpdateLoadingTipForRefresh(LoopListViewItem2 item)
        {
            ...
            else if (mLoadingTipStatusForRefresh == LoadingTipStatus.WaitRelease)
            {
                ...
                item.CachedRectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Vertical,
                    mLoadingTipItemHeightForRefresh);
            }
        ...
        void OnDragingForRefresh()
        {
            ...
            if (mLoadingTipStatusForRefresh != LoadingTipStatus.None && mLoadingTipStatusForRefresh !=
                                                                     LoadingTipStatus.WaitRelease
                                                                     && mLoadingTipStatusForRefresh !=
                                                                     LoadingTipStatus.WaitContinureDrag)
            {
                return;
            }
        ...
        void OnScrollToButtonClicked()
        {
            ...
            itemIndex++;
            int tmpCount = itemIndex / mItemCountPerRow;
            ...
            tmpCount++;
            mLoopListView.MovePanelToItemIndex(tmpCount, 0);
        }
    }
}