    ...
    public class StaggeredGridItemGroup
    {
      ...
      */
        ...
        */
        ...
        {
            get { return mItemIndexMap.Count; }
        }
            ...
            float distanceForNew1)
        {
            ...
            while (needContinueCheck)
            {
                ...
                if (mIsVertList)
                {
                    needContinueCheck = UpdateForVertListPart1(distanceForRecycle0, distanceForRecycle1,
                        distanceForNew0, distanceForNew1);
                }
                else
                {
                    needContinueCheck = UpdateForHorizontalListPart1(distanceForRecycle0, distanceForRecycle1,
                        distanceForNew0, distanceForNew1);
                }
            }
                ...
                if (topPos0.y - mViewPortRectLocalCorners[1].y < distanceForNew0)
                {
                    ...
                    if (nIndex >= mCurReadyMinItemIndex || mNeedCheckNextMinItem)
                    {
                        ...
                        else
                        {
                            ...
                            float y = tViewItem0.CachedRectTransform.anchoredPosition3D.y +
                ...
                if (mViewPortRectLocalCorners[0].y - downPos1.y < distanceForNew1)
                {
                    ...
                    if (nIndex <= mCurReadyMaxItemIndex || mNeedCheckNextMaxItem)
                    {
                        ...
                        else
                        {
                            ...
                            mItemList.Add(newItem);
                            float y = tViewItem1.CachedRectTransform.anchoredPosition3D.y -
                ...
                if (mViewPortRectLocalCorners[1].x - leftPos0.x < distanceForNew0)
                {
                    ...
                    if (nIndex >= mCurReadyMinItemIndex || mNeedCheckNextMinItem)
                    {
                        ...
                        else
                        {
                            ...
                            mItemList.Insert(0, newItem);
                            float x = tViewItem0.CachedRectTransform.anchoredPosition3D.x -
                ...
                if (rightPos1.x - mViewPortRectLocalCorners[2].x < distanceForNew1)
                {
                    ...
                    if (nIndex <= mCurReadyMaxItemIndex || mNeedCheckNextMaxItem)
                    {
                        ...
                        else
                        {
                            ...
                            mItemList.Add(newItem);
                            float x = tViewItem1.CachedRectTransform.anchoredPosition3D.x +
        ...
        public void CheckIfNeedUpdateItemPos()
        {
            ...
            if (mArrangeType == ListItemArrangeType.TopToBottom)
            {
                ...
                if ((-lastItem.BottomY) > viewMaxY || (lastItem.ItemIndexInGroup == mCurReadyMaxItemIndex &&
                                                       (-lastItem.BottomY) != viewMaxY))
                {
                    UpdateAllShownItemsPos();
                    return;
                }
            ...
            else if (mArrangeType == ListItemArrangeType.BottomToTop)
            {
                ...
                if (firstItem.BottomY < 0 ||
                    (firstItem.ItemIndexInGroup == mCurReadyMinItemIndex && firstItem.BottomY != 0))
                {
                    UpdateAllShownItemsPos();
                    return;
                }
                ...
                if (lastItem.TopY > viewMaxY ||
                    (lastItem.ItemIndexInGroup == mCurReadyMaxItemIndex && lastItem.TopY != viewMaxY))
                {
                    UpdateAllShownItemsPos();
                    return;
                }
            ...
            else if (mArrangeType == ListItemArrangeType.LeftToRight)
            {
                ...
                if (firstItem.LeftX < 0 ||
                    (firstItem.ItemIndexInGroup == mCurReadyMinItemIndex && firstItem.LeftX != 0))
                {
                    UpdateAllShownItemsPos();
                    return;
                }
                ...
                if ((lastItem.RightX) > viewMaxX ||
                    (lastItem.ItemIndexInGroup == mCurReadyMaxItemIndex && lastItem.RightX != viewMaxX))
                {
                    UpdateAllShownItemsPos();
                    return;
                }
            ...
            else if (mArrangeType == ListItemArrangeType.RightToLeft)
            {
                ...
                if (firstItem.RightX > 0 ||
                    (firstItem.ItemIndexInGroup == mCurReadyMinItemIndex && firstItem.RightX != 0))
                {
                    UpdateAllShownItemsPos();
                    return;
                }
                ...
                if ((-lastItem.LeftX) > viewMaxX ||
                    (lastItem.ItemIndexInGroup == mCurReadyMaxItemIndex && (-lastItem.LeftX) != viewMaxX))
                {
                    UpdateAllShownItemsPos();
                    return;
                }
