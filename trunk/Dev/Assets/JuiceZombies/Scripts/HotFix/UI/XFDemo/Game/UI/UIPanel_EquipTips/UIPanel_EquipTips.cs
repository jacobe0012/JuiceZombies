...
namespace XFramework
{
    ...
    public partial class UIPanel_EquipTips : UI, IAwake<MyGameEquip>
    {
        ...
        public async void Initialize(MyGameEquip myGameEquip)
        {
            ...
            //attr_speed �ƶ��ٶ�
            //��������equip_levelup_cost
            //common_state_commonװ��
            //common_state_levelup����
            //һ������common_state_levelupclick
            //common_state_removeж��
            //common_state_leveldown����
            //common_state_qualitydown��Ʒ
            //common_state_cancelȡ��
            //common_state_equippingװ����
            //common_state_change����
            //common_state_merge�ϳ�
