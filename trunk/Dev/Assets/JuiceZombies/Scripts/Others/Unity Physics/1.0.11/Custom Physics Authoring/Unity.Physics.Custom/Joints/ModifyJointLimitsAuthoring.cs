                ...
                switch (joint.ValueRW.JointType)
                {
                    ...
                    case JointType.Custom:
                        ...
                        for (var i = 0; i < constraints.Length; i++)
                        {
                            ...
                            var constraintRange =
                                (Math.FloatRange)(new float2(constraint.Min, constraint.Max) * scalar);
